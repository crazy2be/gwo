package §_-CA§
{
   ...
   public class WideEmitter extends Object
   {
      ...
      public function emit(param1:Projectile) : *
      {
         ...
         {
            SafeGlobal.GAME.addProjParticles(param1.lastSimTime,Math.round(this.x),Math.round(this.y),Math.round(this.§_-JB§),Math.round(this.§_-Uv§),this.particle,this.custom,300,2);
         }
      }
   }
}
