package §_-CA§
{
   ...
   public class §_-H5§ extends Object
   {
      
      public function §_-H5§(param1:Sprite, param2:Array = null)
      {
         var _loc3_:* = false;
         var _loc4_:* = true;
         ...
         if(param2)
         {
            _loc4_;
            _loc4_;
            this.§_-w5§(param2[0],param2[1],param2[2],param2[3],param2[4],param2[5],param2[6],param2[7],param2[8]);
         }
         else
         {
            this.§_-w5§(10,0.2,0,1,0.5,0,0,16777215,0);
         }
      ...
      public function §_-w5§(param1:int, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:uint, param9:uint) : *
      {
         var _loc44_:* = false;
         var _loc45_:* = true;
         var _loc25_:* = NaN;
         ...
         _loc10_.addChild(this.§_-2B§);
         var _loc11_:Number = 0;
         var _loc12_:Number = 0;
         _loc45_;
         _loc45_;
         var _loc13_:Number = param7 - param6;
         var _loc14_:int = this.§_-QQ§(param8);
         var _loc15_:int = this.§_-QQ§(param9);
         _loc45_;
         var _loc16_:Number = _loc15_ - _loc14_;
         var _loc17_:int = this.§_-eA§(param8);
         var _loc18_:int = this.§_-eA§(param9);
         _loc44_;
         _loc44_;
         var _loc19_:Number = _loc18_ - _loc17_;
         var _loc20_:int = this.§_-WM§(param8);
         var _loc21_:int = this.§_-WM§(param9);
         _loc45_;
         _loc45_;
         ...
         while(_loc30_ <= 1)
         {
            ...
            while(true)
            {
               ...
               _loc45_;
               _loc45_;
               _loc38_ = this.§_-0j§(_loc34_,_loc35_,_loc36_);
               _loc44_;
               _loc28_ = new Matrix();
               _loc29_ = new Matrix();
               _loc45_;
               ...
               else
               {
                  ...
                  _loc44_;
                  _loc44_;
                  this.spriteSheet.draw(this.§_-2B§,_loc28_,_loc43_,null,null,true);
               }
               _loc31_++;
            }
            _loc30_++;
