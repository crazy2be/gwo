package com.funkypear.ui
{
   ...
   public class §_-nj§ extends §_-A3§
   {
      
      public function §_-nj§(param1:Sprite)
      {
         var _loc2_:* = false;
         var _loc3_:* = true;
         super(param1);
      ...
      public var kreds2:MovieClip;
      
      public var buy_small:§_-0C§;
      
      public var kreds3:MovieClip;
      ...
      public function waitForPayment(param1:int) : void
      {
         ...
         this.kreds1.visible = false;
         this.kreds2.visible = false;
         _loc3_;
         _loc3_;
         this.kreds3.visible = false;
         _loc3_;
         _loc3_;
         _loc3_;
         _loc3_;
      ...
      public function loadPrices() : void
      {
         ...
         var _loc2_:* = true;
         _loc2_;
         Global.lobby_client.loadGravitonKredsPrices();
      }
      ...
      public function displayPrices(param1:String = "") : void
      {
         ...
         _loc12_;
         this.percent_10_clip.visible = true;
         this.kreds1.visible = true;
         _loc12_;
         this.kreds2.visible = true;
         this.kreds3.visible = true;
         ...
         var _loc3_:Array = _loc2_[0].split("KREDS=");
         var _loc4_:Array = _loc2_[1].split("KREDS=");
         var _loc5_:Array = _loc2_[2].split("KREDS=");
         ...
         this.small_price_text.text = String("BUY - " + this.formatNumber(_loc6_));
         this.medium_price_text.text = String("BUY - " + this.formatNumber(_loc7_));
         this.large_price_text.text = String("BUY - " + this.formatNumber(_loc8_));
      }
      ...
      public function clickUpdate() : void
      {
         ...
         var _loc2_:* = false;
         _loc2_;
         Global.lobby_client.requestUpdateGravitons();
         _loc1_;
         _loc1_;
         this.doClose();
      }
