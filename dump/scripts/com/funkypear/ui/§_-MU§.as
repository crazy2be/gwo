package com.funkypear.ui
{
   ...
   public class §_-MU§ extends §_-uw§
   {
      
      public function §_-MU§(param1:Sprite)
      {
         var _loc2_:* = false;
         var _loc3_:* = true;
         super(param1);
      ...
      public function displayPrices(param1:String = "") : void
      {
         ...
         var _loc3_:Array = _loc2_[0].split("MC=");
         var _loc4_:Array = _loc2_[1].split("MC=");
         var _loc5_:Array = _loc2_[2].split("MC=");
