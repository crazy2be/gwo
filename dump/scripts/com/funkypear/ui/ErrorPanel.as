package com.funkypear.ui
{
   ...
   public class ErrorPanel extends Sprite
   {
      ...
      public function ErrorPanel()
      {
         ...
         _loc1_;
         super();
         this.anim_holder_1.addChild(this.§_-bt§());
         this.anim_holder_2.addChild(this.§_-bt§());
         _loc1_;
         this.anim_holder_3.addChild(this.§_-bt§());
         _loc1_;
         this.anim_holder_4.addChild(this.§_-bt§());
         this.anim_holder_5.addChild(this.§_-bt§());
         this.anim_holder_6.addChild(this.§_-bt§());
      }
      ...
      private function §_-bt§() : MovieClip
      {
         var _loc14_:* = false;
         var _loc15_:* = true;
         _loc15_;
