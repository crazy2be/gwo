package §_-ZN§
{
   ...
   public class SubmitRegisterButton extends SimpleButton
   {
      ...
      override public function onClick(param1:MouseEvent) : void
      {
         ...
         {
            _loc4_;
            if(this.§_-xl§((parent as §_-PN§).name_text.text,(parent as §_-PN§).§_-zm§.text,(parent as §_-PN§).§_-v5§.text))
            {
               _loc5_;
               if(this.§_-hx§((parent as §_-PN§).name_text.text))
               {
                  _loc5_;
                  if(this.§_-Ag§((parent as §_-PN§).§_-zm§.text,(parent as §_-PN§).§_-wI§.text))
                  {
                     _loc5_;
                     _loc5_;
                     if(this.static((parent as §_-PN§).§_-v5§.text))
                     {
                        setDisabled(true);
                        (parent as §_-PN§).response_text.text = "";
                        _loc5_;
                        _loc5_;
                        ...
                        _loc5_;
                        _loc5_;
                        TimelineGlobal.input_username = (parent as §_-PN§).name_text.text;
                        TimelineGlobal.input_password = (parent as §_-PN§).§_-zm§.text;
                        TimelineGlobal.input_email = (parent as §_-PN§).§_-v5§.text;
                     ...
                     else
                     {
                        try
                        {
                           (parent as §_-PN§).response_text.text = "PLEASE ENTER A VALID EMAIL ADDRESS.";
                        }
                        catch(e:Error)
                        {
                        }
                  ...
                  else
                  {
                     try
                     {
                        (parent as §_-PN§).response_text.text = "PLEASE ENTER A VALID PASSWORD.\n6-16 CHARACTERS. LETTERS AND NUMBERS ONLY.";
                     }
                     catch(e:Error)
                     {
                     }
               ...
               else
               {
                  try
                  {
                     (parent as §_-PN§).response_text.text = "PLEASE ENTER A VALID USERNAME.\n6-16 CHARACTERS. LETTERS AND NUMBERS ONLY.";
                     _loc4_;
                  }
                  catch(e:Error)
                  {
            ...
            else
            {
               try
               {
                  if((parent as §_-PN§).name_text.text == "")
                  {
                     _loc5_;
                     (parent as §_-PN§).response_text.text = "PLEASE ENTER A VALID USERNAME.\n6-16 CHARACTERS. LETTERS AND NUMBERS ONLY.";
                     _loc5_;
                  ...
                  else if((parent as §_-PN§).§_-zm§.text == "")
                  {
                     _loc5_;
                     (parent as §_-PN§).response_text.text = "PLEASE ENTER A VALID PASSWORD.\n6-16 CHARACTERS. LETTERS AND NUMBERS ONLY.";
                     _loc5_;
                  ...
                  else if((parent as §_-PN§).§_-v5§.text == "")
                  {
                     _loc4_;
                     _loc4_;
                     (parent as §_-PN§).response_text.text = "PLEASE ENTER A VALID EMAIL ADDRESS.";
