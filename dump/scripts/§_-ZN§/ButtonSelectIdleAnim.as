package §_-ZN§
{
   ...
   public class ButtonSelectIdleAnim extends SimpleButton
   {
      
      public function ButtonSelectIdleAnim()
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
         _loc1_;
      ...
      override public function onClick(param1:MouseEvent) : void
      {
         ...
         _loc2_;
         _loc2_;
         LP_TeamSetUp(parent).§_-90§(this.pos,x,y);
      }
