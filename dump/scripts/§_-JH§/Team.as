package §_-JH§
{
   public class Team extends Object
   {
      ...
      public function §_-AD§(param1:Boolean) : *
      {
         var _loc17_:* = false;
         var _loc18_:* = true;
               ...
               while(_loc9_ < _loc8_.length)
               {
                  ...
                  else
                  {
                     ...
                     else if(_loc11_[0] == "e")
                     {
                        ...
                        else if(int(_loc11_[1]) == SafeGlobal.§_-SM§)
                        {
                           _loc18_;
                           _loc18_;
                           _loc13_ = uint(_loc11_[2]);
                           _loc16_ = SafeGlobal.GAME.generateCustomParticle(SafeGlobal.§_-Fw§,0.2,0.4,SafeGlobal.cw_trail_colours[_loc13_],SafeGlobal.cw_trail_colours[_loc13_],1,0.1,0);
                           _loc17_;
                           _loc17_;
                           _loc12_ = "e," + _loc11_[1] + "," + _loc16_;
                        }
