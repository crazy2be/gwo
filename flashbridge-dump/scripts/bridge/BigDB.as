package bridge
{
   import bridge.generated.BigDB;
   import playerio.BigDB;
   import bridge.utils.*;
   import bridge.generated.messages.*;
   import bridge.generated.LockType;
   
   public class BigDB extends bridge.generated.BigDB implements BigDB
   {
      ...
      {
         var db:BigDBObjectId = null;
         var table:String = param1;
         var key:String = param2;
         var callback:Function = param3;
         var errorHandler:Function = param4;
         db = new BigDBObjectId();
         db.table = table;
         db.keys = [key];
         _loadObjects([db],function(param1:Array):*
         {
            if(callback != null)
            {
      ...
      public function loadSingle(param1:String, param2:String, param3:Array, param4:Function = null, param5:Function = null) : void
      {
         ...
         var callback:Function = param4;
         var errorHandler:Function = param5;
         _loadMatchingObjects(table,index,Converter.toValueObjectArray(indexValue),1,function(param1:Array):*
         {
            if(callback != null)
            {
               callback(Converter.toDatabaseObject(table,param1[0],false,save));
      ...
      public function loadRange(param1:String, param2:String, param3:Array, param4:Object, param5:Object, param6:int, param7:Function = null, param8:Function = null) : void
      {
         ...
         var startIndexValue:* = !(start == null)?[start]:[];
         var stopIndexValue:* = !(stop == null)?[stop]:[];
         if(path != null)
         {
            startIndexValue = path.concat(startIndexValue);
            stopIndexValue = path.concat(stopIndexValue);
         }
         _loadIndexRange(table,index,Converter.toValueObjectArray(startIndexValue),Converter.toValueObjectArray(stopIndexValue),limit,function(param1:Array):*
         {
            if(callback != null)
            {
               callback(toDatabaseObjectArray(table,param1));
      ...
      {
         var _loc8_:* = !(param4 == null)?[param4]:[];
         var _loc9_:* = !(param5 == null)?[param5]:[];
         if(param3 != null)
         {
            _loc8_ = param3.concat(_loc8_);
            _loc9_ = param3.concat(_loc9_);
         }
         _deleteIndexRange(param1,param2,Converter.toValueObjectArray(_loc8_),Converter.toValueObjectArray(_loc9_),param6,param7);
      }
      ...
      private function save(param1:String, param2:String, param3:String, param4:Object, param5:Boolean, param6:Boolean = false, param7:Function = null, param8:Function = null) : *
      {
         var table:String = param1;
         var key:String = param2;
         ...
         _saveObjectChanges(LockType.LOCKALL,[cs],createIfMissing,function(param1:Array):*
         {
            callback(param1[0]);
         },errorHandler);
      }
