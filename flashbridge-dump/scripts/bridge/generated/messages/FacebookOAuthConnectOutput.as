package bridge.generated.messages
{
   ...
   public final class FacebookOAuthConnectOutput extends Message
   {
      ...
      public function FacebookOAuthConnectOutput()
      {
         ...
         registerField("facebookUserId","",Descriptor.STRING,Descriptor.LABEL_OPTIONAL,5);
         registerField("partnerId","",Descriptor.STRING,Descriptor.LABEL_OPTIONAL,6);
         registerField("playerInsightState","bridge.generated.messages.PlayerInsightState",Descriptor.MESSAGE,Descriptor.LABEL_OPTIONAL,7);
      }
