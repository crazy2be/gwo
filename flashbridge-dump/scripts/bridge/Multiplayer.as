package bridge
{
   import bridge.generated.Multiplayer;
   import playerio.Multiplayer;
   import bridge.utils.HTTPChannel;
   
   public class Multiplayer extends bridge.generated.Multiplayer implements Multiplayer
   {
      ...
      public function joinRoom(param1:String, param2:Object, param3:Function = null, param4:Function = null) : void
      {
         ...
         _joinRoom(roomId,joinData,!(_developmentServer == null),function(param1:String, param2:Array):*
         {
      ...
      public function createJoinRoom(param1:String, param2:String, param3:Boolean, param4:Object, param5:Object, param6:Function = null, param7:Function = null) : void
      {
         ...
         _createJoinRoom(roomId,roomType,visible,roomData,joinData,!(_developmentServer == null),function(param1:String, param2:String, param3:Array):*
         {
      ...
      {
         var _loc7_:* = new Connection(client,param1,param2,param3,param4,param5,param6,_developmentServer);
      }
   }
}
